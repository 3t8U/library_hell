...
COPY public.authors (name, id, bio) FROM stdin;
\.
...
COPY public.books (name, id, genre) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.authors_books_id_seq', 32, true);
...
SELECT pg_catalog.setval('public.authors_id_seq', 191, true);
...
SELECT pg_catalog.setval('public.books_id_seq', 258, true);
